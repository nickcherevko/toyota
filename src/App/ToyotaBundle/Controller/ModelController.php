...
use App\ToyotaBundle\Entity\Model;
use App\ToyotaBundle\Form\ModelType;
...
class ModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppToyotaBundle:Model')->findAll();
     ...
     * @Method("POST")
     * @Template("AppToyotaBundle:Model:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppToyotaBundle:Model')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppToyotaBundle:Model:edit.html.twig")
     */
