...
use App\ToyotaBundle\Entity\Auto;
use App\ToyotaBundle\Form\AutoType;
...
class AutoController extends Controller
{
     ...
     *
     * @Route("/", name="auto_create")
     * @Method("POST")
     * @Template("AppToyotaBundle:Auto:new.html.twig")
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="auto_update")
     * @Method("PUT")
     * @Template("AppToyotaBundle:Auto:edit.html.twig")
     */
